...
export function Footer() {
    return (
        <footer className="bg-[#0A0F1E] border-t border-[#374151] pt-14 pb-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-[#9CA3AF] text-sm leading-relaxed">
                            AI-powered textile fabric analysis for the modern industry. Fast, accurate, and scalable.
                        </p>
                    </div>
                ...
                <div className="pt-8 border-t border-[#374151] flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-[#6B7280]">
                        © 2026 ThreadCounty. All rights reserved.
                    </p>
                    <div className="flex gap-2">
                        {/* Twitter */}
                        <Link
                            href="#"
                            className="w-8 h-8 rounded-lg border border-[#374151] hover:border-indigo-500/50 flex items-center justify-center text-[#9CA3AF] hover:text-indigo-400 transition-all"
                        >
